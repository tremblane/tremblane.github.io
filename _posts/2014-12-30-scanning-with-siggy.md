...
Short version: Constantly use the Mass Sig Reader. Using the Mass Sig Reader tool you can only add information; pasting in less information than what is in siggy will not erase things. If somebody else has full details about a signature entered in siggy and you paste in a partial signature (only the type, or no details at all), then it will ignore your update and leave the details there. Multiple people can be scanning a system and pasting in information at the same time.
